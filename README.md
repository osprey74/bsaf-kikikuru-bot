...
bsaf-kikikuru-bot monitors the Japan Meteorological Agency (JMA) public XML feed for the new "R06" weather warnings and advisories — telegrams VPWW55–61, operational since 2026-05-29 — designated-river flood forecasts (VXKO), and weather disaster-prevention briefings (VPBS50: linear precipitation bands, significant snowfall), automatically posting them to Bluesky with structured BSAF tags. BSAF-compatible clients can filter posts by phenomenon, alert level, and prefecture.
