...
bsaf-kikikuru-bot は気象庁の防災情報XMLフィードを監視し、新気象警報・注意報（Ｒ０６）電文（VPWW55〜61、2026-05-29 運用開始）および指定河川洪水予報（VXKO）を BSAF タグ付きで Bluesky に自動投稿します。BSAF 対応クライアントでは、現象種別・警戒レベル・都道府県によるフィルタリングが可能です。
...
指定河川洪水予報（VXKO）は 1 投稿 = 1 都道府県 × 1 警戒レベルで配信し、対象河川名を本文に列挙します。
